 ...
 * WeatherDataDto contains all setters and getters methods
 * 
 */
public class WeatherDataDto {
	...
	/**
	 * return the value as 
	 * @return String position, conditions, temparature, pressure, humidity, city, localtime, timeOffset
	 */
	@Override
	public String toString() {
			return "position: "+position+", conditions: "+conditions+
		    		 ", temparature: "+temparature+", pressure: "+pressure+", humidity: "+humidity+
		     ", city: "+city+", localtime: "+localtime+", timeOffset: "+timeOffset;
		  }
